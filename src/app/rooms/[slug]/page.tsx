    ...
    <>
      ...
      <div className="px-4 sm:px-10 pb-[60px] max-w-[1200px] mx-auto">
        <div className="grid grid-cols-3 grid-rows-2 gap-2 rounded-2xl overflow-hidden h-[480px] max-sm:grid-cols-1 max-sm:grid-rows-3 max-sm:h-auto">
          <div className="row-span-2 max-sm:row-span-1 bg-gradient-to-br from-[#e2e2e2] to-[#eee] flex items-center justify-center text-mid relative">
            <PhotoIcon />
            <span className="absolute bottom-3 left-3 bg-black/60 text-white text-[0.65rem] px-2.5 py-1 rounded">メイン写真</span>
          </div>
          <div className="bg-gradient-to-br from-[#e2e2e2] to-[#eee] flex items-center justify-center text-mid relative max-sm:hidden">
            <PhotoIcon />
            <span className="absolute bottom-3 left-3 bg-black/60 text-white text-[0.65rem] px-2.5 py-1 rounded">テーブル</span>
          </div>
          <div className="bg-gradient-to-br from-[#e2e2e2] to-[#eee] flex items-center justify-center text-mid relative max-sm:hidden">
            <PhotoIcon />
            <span className="absolute bottom-3 left-3 bg-black/60 text-white text-[0.65rem] px-2.5 py-1 rounded">設備</span>
          </div>
          <div className="bg-gradient-to-br from-[#e2e2e2] to-[#eee] flex items-center justify-center text-mid relative max-sm:hidden">
            <PhotoIcon />
            <span className="absolute bottom-3 left-3 bg-black/60 text-white text-[0.65rem] px-2.5 py-1 rounded">室内</span>
          </div>
          <div className="bg-gradient-to-br from-[#e2e2e2] to-[#eee] flex items-center justify-center text-mid relative max-sm:hidden">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3.5">
          {others.map((other) => (
            <Link
              ...
              className="bg-off rounded-2xl p-6 text-center hover:-translate-y-0.5 hover:shadow-lg transition-all"
            >
              <div className="w-[52px] h-[52px] bg-white rounded-xl mx-auto mb-2.5 flex items-center justify-center text-mid">
...
function PhotoIcon() {
  return (
    <svg className="w-8 h-8 text-[#ccc]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
