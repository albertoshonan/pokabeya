          ...
          <div>
            ...
            <div className="border border-light rounded-2xl p-7 mb-5">
              ...
              <a
                ...
                className="flex items-center justify-center gap-2 w-full border border-light text-dark py-3 rounded-full text-sm hover:border-black transition-colors mt-2.5"
              >
                <svg className="w-[18px] h-[18px]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
